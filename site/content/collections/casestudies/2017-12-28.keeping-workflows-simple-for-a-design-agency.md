...
replicator_content:
  ...
  - 
    type: blockquote
    quote: 'We are always looking for solutions to make things more efficient. We produce 1 million renderings per month - you need to organise things well, otherwise you can’t handle this volume. In the past we couldn’t find a tool to improve workflows - we were excited to find Precursive which is great for our needs.'
