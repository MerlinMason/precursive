  ...
  - 
    ...
    text: |
      **Why we chose Precursive**
      ...
      Kantar states: "We needed a solution that was rich in functionality but simple to use. Given our use of Salesforce CRM, we wanted to have some alignment with our commercial activities. We needed to trust that the solution would be robust, secure and well supported."
  - 
    type: blockquote
