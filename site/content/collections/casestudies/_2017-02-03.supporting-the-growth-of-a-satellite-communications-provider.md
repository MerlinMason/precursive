...
replicator_content:
  ...
  - 
    type: blockquote
    quote: 'Precursive has helped us to manage projects globally using simple to use integrated tools on the Salesforce Platform.  Instead of using multi-platforms such as Salesforce, Excel Spreadsheets and MS Project to track projects the Precursive tool integrates all these features which enables the PMO to have visibility of all projects managed by project managers and able to provide specific reports for senior managers as well as the Precursive bespoke global charts view snapshot of project data. The results we are seeing in using the Precursive Tool is that we can reduce Project timelines, find efficiencies and therefore reduce our costs in delivering projects. '
