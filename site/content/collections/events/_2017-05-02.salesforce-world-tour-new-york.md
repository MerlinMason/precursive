...
section_event_greater_text: |
  ...
  We’ll be serving up all the tips and tricks you need to boost productivity, performance and profitability - so you can make every New York minute count.
...
top_picks_replicator:
  - 
    ...
    text: |
      ...
      Hi! I work with our customers to help them grow and scale their business.
      
      Before this I was a Senior Director  at CEB (Gartner) advising Fortune 500 companies on their sales and marketing strategy and implementing commercial excellence programs.
  - 
    type: top_picks_grid
    text: |
      # Stop being busy and start being cool in NYC
      ## **Free yourself of ‘busy-ness’ and spend time delighting customers.**
...
case_studies_header:
  - 
    ...
    case_studies_subtitle: 'Come find out why Precursive is the #1 app on the Salesforce AppExchange for taking resource management, project teams and customer experience to the next level.'
components: [ ]
tags: [ ]
