...
top_picks_replicator:
  - 
    ...
    text: |
      ...
      Before this I was a Senior Director  at CEB (Gartner) advising Fortune 500 companies on their commercial strategy and implementing commercial excellence programs.
  - 
    type: top_picks_grid
    text: |
...
case_studies_header:
  - 
    ...
    case_studies_subtitle: 'Speak with us at Salesforce World Tour to find out why Precursive is the #1 app on         Salesforce AppExchange for taking resource management, project teams and customer experience to the next level.'
components: [ ]
tags: [ ]
