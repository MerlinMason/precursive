...
replicator_content:
  ...
  - 
    ...
    text: |
      ...
      Wade showed a really quick example of how opensource components can be used in the Lighntning Page builder in a few seconds. Using some components built by [Appiphony](http://www.lightningstrike.io/)
  - 
    type: image
    image:
      - /assets/29_-_introducing_Salesforce_DX_qklwxw.png
  - 
    type: paragraph
    text: |
