...
replicator_content:
  ...
  - 
    ...
    text: |
      ...
      At World Tour New York, Precursive will preview how to push project delivery data through Salesforce's Wave Analytics Cloud to show you patterns of:
      
      + Where projects go off course and why
      + Crunching pipeline and sold work data to predict capacity needs
      + Hiring more of the RIGHT skill sets
      + Re-engineering delivery data to optimise where you sell and invest
