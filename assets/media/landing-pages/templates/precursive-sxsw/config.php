...
* Template Name:    Precursive SXSW 2015
...
array(
    ...
    'label' => "Precursive SXSW 2015", // Nice Name
...
array(
    ...
    array(
        ...
        'description' => 'The vertical space between SXSW logos',
        'id' => 'space-between',
        'type' => 'text',
        'default' => '80'
        ),
    array(
        'label' => 'Intro Copy',
        'description' => 'The introduction copy',
        'id' => 'intro-copy',
        'type' => 'wysiwyg',
        'default' => 'Precursive helps a wide range of creative companies become more profitable by offering a tool that helps manage their resources more effectively.'
        ),
    array(
        'label' => 'Main Heading',
        ...
        'id' => 'main-heading',
        'type' => 'wysiwyg',
        'default' => 'Why not see how much you could save?'
        ),
    array(
        'label' => 'Book Copy',
        'description' => 'The copy before the book button',
        'id' => 'book-copy',
        'type' => 'wysiwyg',
        'default' => 'Attending SXSW 2015? Book some time with our CEO James Gasteen to learn how resources management could be costing you more than you think.'
        ),
    array(
        'label' => 'Book Button Text',
        'description' => 'The book button text',
        'id' => 'book-button-text',
        'type' => 'text',
        'default' => 'Book a call'
        ),
    array(
        'label' => 'Book Info Copy',
        'description' => 'The book info copy',
        'id' => 'book-info-copy',
        'type' => 'wysiwyg',
        'default' => ''
        ),
    array(
        'label' => 'Book Contact Details',
        'description' => 'The contact details',
        'id' => 'book-contact-details',
        'type' => 'wysiwyg',
        'default' => ''
        ),
    array(
